...
import placeholder from "../image/beth.JPG";
    ...
    <div className="flex items-stretch justify-center md:w-1/3 md:p-5 sm:p-2 flex-0">
      <div className="flex flex-col bg-gray-100 justify-between text-center rounded-3xl border shadow-lg p-10 max-w-xs">
        <div className=" font-semibold ">
          ...
          />
          <h1 class="text-lg text-gray-700"> Beth Cooper </h1>
          <h3 class="text-sm text-gray-400 "> President </h3>
          <p class="text-xs text-left text-gray-400 mt-4 w-full">
            <span className="font-bold">Fun Fact: </span>
            <span>I can read 7 languages!</span>
            <span className="text-transparent">
              This is white out to give the width more space.
            </span>
          </p>
        </div>
        <div>
                ...
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    <div className="flex items-start justify-between p-4 border-b border-solid border-slate-200 rounded-t">
                      <h3 className="text-3xl font-semibold">Beth Cooper</h3>
                      <button
                    ...
                    <div className="relative p-4 flex-auto">
                      ...
                      <div className="flex md:flex-row sm:flex-col text-sm justify-start text-left">
                        ...
                        <div className="md:w-1/2 text-base">
                          ...
                          <span className="text-slate-500"> Archaelogy</span>
                        </div>
                      </div>
                      ...
                      <p className="text-slate-500 text-base text-left">
                        Questbridge for me represents a source of community and
                        support. Many of my friends are fellow scholars and I
                        wouldn't have made it as far as I have without their
                        help.
                      </p>
                      <p className="text-base text-left mt-4 font-bold">
                      ...
                      <p className="text-slate-500 text-base text-left">
                        I'm excited to help our Chapter be the best it can be! I
                        want to help give future scholars access to the same
                        support network that I had access to.
                      </p>
                      <p className="text-base text-left mt-4 font-bold">
                        Word of Advice?
                      </p>
                      <p className="text-slate-500 text-base text-left">
                        Always check Resource Center emails, some of their
                        events are extremely helpful in a busy year!
                      </p>
                    </div>
